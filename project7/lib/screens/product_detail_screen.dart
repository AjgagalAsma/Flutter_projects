...
class ProductDetailScreen extends StatelessWidget {
  static const screenRoute = "/screen_product_detail";
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: buildFloatingActionButton(ProductId),
    );
  }

  FloatingActionButton buildFloatingActionButton(String ProductId) {
    return FloatingActionButton(
      child: Icon(
        isFavorite(ProductId) ? Icons.star : Icons.star_border,
        color: Colors.black,
      ),
      onPressed: () {
